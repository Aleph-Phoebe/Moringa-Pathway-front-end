...
This is the main repo for this application 
If you would like to fork this repo FOR USE LOCALLY Fork it from 
 [https://github.com/DestinyG-beep/moringapathway.git]
 
1. Clone the repository:
   ```bash
   git clone  (https://github.com/DestinyG-beep/moringapathway.git)
   cd moringapathway]
...
# Premium Content
It is accessible when a user upgrades on the premium page.
...
## Premium Content
Users have access to exclusive resources such as guides, templates, and interview questions. 
Premium Users can access a premium page by upgrading on the resources page, view detailed information about each resource and navigate to external links for more information.

## Admin Management
Admins can manage user accounts. They can view, edit, and delete user accounts, as well as update user roles, including promoting users to admin. This allows admins to manage the user base and ensure the application is running smoothly.
